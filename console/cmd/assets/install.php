...
require_once($root.'bin'.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'filesystem'.DIRECTORY_SEPARATOR.'cleanFolder.php');
require_once($root.'bin'.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'filesystem'.DIRECTORY_SEPARATOR.'copyFolder.php');
